...
%% load attacks
load Attacks.mat
iter_attacks = size(Attacks,1);                            % from n_attack=2 to n_attack=20 
...
for iter1 = 1:iter_attacks
    for iter2 = 11:iter_sum_per_attack
        ...
        %% Get results
        time_vec  = simOut.logsout.getElement('r_deviation').Values.Time;

        % State vectors
        % MLP1 + pruning
        r_deviation = simOut.logsout.getElement('r_deviation').Values.Data; 
        yc_deviation  = simOut.logsout.getElement('yc_deviation').Values.Data; 
        % MLP1
        r_deviation2 = simOut.logsout.getElement('r_deviation2').Values.Data; 
        yc_deviation2  = simOut.logsout.getElement('yc_deviation2').Values.Data; 
        % MLP2 + pruning
        r_deviation3 = simOut.logsout.getElement('r_deviation3').Values.Data; 
        yc_deviation3  = simOut.logsout.getElement('yc_deviation3').Values.Data; 
        % MLP2
        r_deviation4 = simOut.logsout.getElement('r_deviation4').Values.Data; 
        yc_deviation4  = simOut.logsout.getElement('yc_deviation4').Values.Data;
        % precision
        ...
        txt = ['simulation at loop', num2str((iter1-1)*iter_sum_per_attack + iter2)];
        disp(txt)
    end
end
